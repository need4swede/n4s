...
Prism.languages.python = {
    ...
    keyword: /\b(?:_(?=\s*:)|assert|async|args|await|case|class|continue|debug|del|Destination|Directory|exec|File|finished|fn|global|index|Input|Include_Period|i|link|kwargs|lambda|match|Name|nonlocal|overwrite|parent|path|Print|raise|Read_Filename|Rename|result|self|signals|Source|threadpool|Uppercase|yield)\b/,
