...
Prism.languages.python = {
    ...
    keyword: /\b(?:_(?=\s*:)|assert|async|args|await|case|class|continue|del|exec|finished|fn|global|index|i|link|kwargs|lambda|match|nonlocal|parent|path|print|raise|result|self|signals|threadpool|yield)\b/,
