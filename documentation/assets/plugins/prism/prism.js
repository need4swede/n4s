...
Prism.languages.python = {
    ...
    keyword: /\b(?:_(?=\s*:)|assert|async|args|Attachment|await|Body|case|class|continue|debug|del|Destination|Directory|exec|File|finished|fn|global|index|Input|Include_Period|i|link|kwargs|lambda|Make|match|Name|nonlocal|overwrite|parent|path|Print|raise|Read_Filename|Rename|result|self|Send_To|signals|Source|Subject|threadpool|Uppercase|yield)\b/,
