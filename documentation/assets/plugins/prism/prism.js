...
Prism.languages.python = {
    ...
    keyword: /\b(?:_(?=\s*:)|assert|async|args|await|case|class|continue|debug|del|Destination|exec|finished|fn|global|index|i|link|kwargs|lambda|match|nonlocal|overwrite|parent|path|print|raise|result|self|signals|Source|threadpool|yield)\b/,
