...
Prism.languages.python = {
    ...
    keyword: /\b(?:_(?=\s*:)|assert|async|args|await|case|class|continue|debug|del|Destination|exec|finished|fn|global|index|Input|Include_Period|i|link|kwargs|lambda|match|nonlocal|overwrite|parent|path|print|Print|raise|result|self|signals|Source|threadpool|Uppercase|yield)\b/,
